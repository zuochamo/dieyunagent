...
(function initModelRuntimePresets(global) {
  ...
  const FALLBACK_CONTEXT_TIER_IDS = MODEL_RUNTIME_PRESETS.map((p) => p.id);
  ...
  if (typeof global === 'object' && global) {
    global.MODEL_RUNTIME_PRESETS = MODEL_RUNTIME_PRESETS;
    global.MODEL_RUNTIME_DEFAULTS = MODEL_RUNTIME_DEFAULTS;
    global.FALLBACK_CONTEXT_TIER_IDS = FALLBACK_CONTEXT_TIER_IDS;
    global.getModelRuntimePresetById = getModelRuntimePresetById;
    global.remapLegacyContextTierId = remapLegacyContextTierId;
    global.foldLegacyContextTierRecord = foldLegacyContextTierRecord;
  }
